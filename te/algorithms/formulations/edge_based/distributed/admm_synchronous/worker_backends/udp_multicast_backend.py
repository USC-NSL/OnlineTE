...
class MulticastWorkerBackend(SynchADMMWorkerBackendBase):
    def __init__(self, rpc_params: MulticastWorkerBackendParams):
        ...
        self._gather_socket.settimeout(rpc_params.Timeout)
        self._gather_socket.bind((rpc_params.ScatterAddress, rpc_params.ScatterPort))
...
class NetworkWorkerNodeListener(DistributedADMMSolverServicer):
    def __init__(self, backend: MulticastWorkerBackend):
